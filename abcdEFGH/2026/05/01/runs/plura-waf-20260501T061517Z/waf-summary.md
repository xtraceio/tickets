...
공격자 IP 78.153.140.93에서 오늘 총 3개 정탐이 탐지되었습니다. PHP/WordPress 계열 경로 스캔이 반복되었고, / 요청은 WAF에서 차단되었습니다. PLURA-WAF 세션 차단뿐 아니라 IP주소 차단 검토가 필요합니다.
...
|---|---:|---:|---|---|
| WAF-S001 VT malicious ratio | 90 | false | 78.153.140.93 | VT 분석 결과가 없어 수동차단 후보로 올리지 않습니다. |
...
| WAF-S004 Scanning High threshold | 50 | false | 185.191.171.8 | 스캐닝성 HIGH 이벤트가 기준 10건에 도달하지 않았습니다. |
| WAF-S005 Scanning Critical threshold | 65 | false | 185.191.171.8 | 스캐닝성 CRITICAL 이벤트가 기준 3건에 도달하지 않았습니다. |
...
| WAF-S008 AI malicious probability | 75 | false | 185.191.171.8 | AI 분석 결과가 없어 수동차단 후보로 올리지 않습니다. |
...
- uri: /
- host: 130.162.156.89
- remoteIp: 78.153.140.93
- responseStatus: 406

## 담당자 확인 항목

1. 공격자 IP 78.153.140.93의 동일 시간대 반복 요청 전체 확인
